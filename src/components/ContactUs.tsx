    ...
    <div className="relative" id="contactus">
      <Dock magnification={60} distance={100}>
        ...
        <DockIcon className="p-3">
          <a
            href="https://www.linkedin.com/in/smb-h/"
            target="_blank"
...
const Icons = {
  ...
  // Simple Telegram icon using lucide's Send icon
