    ...
    <section id="faq" className="container py-12 sm:py-18">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger>What is DataFlux?</AccordionTrigger>
          <AccordionContent>
            DataFlux provides cutting-edge AI infrastructure solutions for businesses, startups, and companies. We offer GPU-powered virtual machines, pods, and platforms to train, fine-tune, and deploy AI models efficiently.
          </AccordionContent>
        </AccordionItem>

        <AccordionItem value="item-2">
          <AccordionTrigger>How does DataFlux pricing work?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger>Can I train and fine-tune my models on DataFlux?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger>How do I get started with DataFlux?</AccordionTrigger>
          <AccordionContent>
