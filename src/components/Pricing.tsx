...
const pricingSections: PricingProps[] = [
  ...
  },
  {
    ...
    description:
      "Deploy and manage serverless workloads with ease. Pay only for the resources you use, and scale seamlessly as your demand grows. You only pay for what you use on OtterByte, billed by the second. When you don’t run anything, it scales to zero and you don’t pay a thing.",
    plans: [
      {
        name: "Basic Compute",
  ...
  },
  {
    title: "Public Models",
    description:
      "Thousands of open-source machine learning models have been contributed by our community and more are added every day. When running or training one of these models, you only pay for the time it takes to process your request.Each model runs on different hardware and takes a different amount of time to run. You’ll find estimates for how much they cost under 'Run time and cost' on the model’s page. For example, for stability-ai/sdxl:This model costs approximately $0.012 to run on OtterByte, but this varies depending on your inputs.Predictions run on Nvidia A40 (Large) GPU hardware, which costs $0.000725 per second. Predictions typically complete within 17 seconds.",
    plans: [
      {
  ...
  },
  {
    title: "Video Models",
    description:
      "OtterByte hosts a selection of video models. These are either priced per video or per second of video generated by the model, allowing you to choose the pricing structure that best fits your project needs.",
    plans: [
      {
  ...
  },
  {
    ...
    description:
      "OtterByte hosts a selection of powerful language models, including Llama 3 and Mistral. Pricing is based on the number of tokens processed. A language model processes text by breaking it into tokens, or pieces of words. OtterByte uses the Llama tokenizer to calculate the number of tokens in text inputs and outputs once it's finished.Learn more about how language model pricing works.",
    plans: [
      {
